...
class TestFileRepository:
    async def test_file_repository_get_by_id(
        self,
    ...
    async def test_file_repository_get_by_id_not_exists_file(
        self,
        file_repository: FileRepository,
    ) -> None:
    ...
    async def test_file_repository_create_file(
        self,
        session: AsyncSession,
        file_repository: FileRepository,
    ) -> None:
        ...
        assert selected_file.id is not None
    ...
    async def test_file_repository_delete_by_id(
        self,
        session: AsyncSession,
        file_repository: FileRepository,
    ) -> None:
